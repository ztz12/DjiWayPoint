...
/**
 * Created by wrs on 21/11/2019,下午 4:41
 * projectName: Testz
 * packageName: com.example.administrator.testz.waypoint
 */
 ...
 * 实现waypiont和图传现实功能
 */
public class Main3DActivity extends FragmentActivity implements View.OnClickListener, OnMapClickListener, TextureView.SurfaceTextureListener {
    ...
    private double droneLocationLat = 181, droneLocationLng = 181,droneAltitude= 181;
    ...
    private void setResultToToast(final String string) {
        Main3DActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Main3DActivity.this, string, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//        LatLng shenzhen = new LatLng(22.5362, 113.9454);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_pointmap3);
...
//            ("is not connect");
    ...
    private void markWaypoint(LatLng point) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_aux_normal));
    ...
    private void configWayPointMission() {
        ...
        //waypointMissionBuilder.build().getWaypointList().toString()  //上传的list
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(Main3DActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
