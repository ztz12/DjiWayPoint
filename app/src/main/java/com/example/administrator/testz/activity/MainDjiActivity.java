...
import com.example.administrator.testz.nettydji.MessageListener;
import com.example.administrator.testz.nettydji.NettyClient;
import com.example.administrator.testz.nettydji.NettyListener;
...
public class MainDjiActivity extends AppCompatActivity implements
        MessageListener, NettyListener {

    private static final String TAG = MainDjiActivity.class.getSimpleName();
    ...
    private boolean startNetty = true;
    ...
    private void startSDKRegistration() {
        if (isRegistrationInProgress.compareAndSet(false, true)) {
            AsyncTask.execute(new Runnable() {
                @Override
                public void run() {
                    ToastUtils.setResultToToast(MainDjiActivity.this.getString(R.string.sdk_registration_doing_message));
                    DJISDKManager.getInstance().registerApp(MainDjiActivity.this.getApplicationContext(), new DJISDKManager.SDKManagerCallback() {
                        @Override
                        public void onRegister(DJIError djiError) {
                            if (djiError == DJISDKError.REGISTRATION_SUCCESS) {
                                DJILog.e("App registration", DJISDKError.REGISTRATION_SUCCESS.getDescription());
                                DJISDKManager.getInstance().startConnectionToProduct();
                                ToastUtils.setResultToToast(MainDjiActivity.this.getString(R.string.sdk_registration_success_message));
                                showDBVersion();
                            } else {
                                ToastUtils.setResultToToast(MainDjiActivity.this.getString(R.string.sdk_registration_message) + djiError.getDescription());
                            }
