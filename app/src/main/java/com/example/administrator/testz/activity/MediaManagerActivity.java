    ...
    protected void onDestroy() {
        ...
        if (isMavicAir2() || isM300()) {
            if (DJISampleApplication.getCameraInstance() != null) {
                DJISampleApplication.getCameraInstance().exitPlayback(djiError -> {
                    if (djiError != null) {
                        DJISampleApplication.getCameraInstance().setFlatMode(SettingsDefinitions.FlatCameraMode.PHOTO_SINGLE, djiError1 -> {
                            if (djiError1 != null){
                ...
                DJISampleApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.SHOOT_PHOTO, djiError -> {
                    if (djiError != null){
        ...
        if (DJISampleApplication.getProductInstance() == null) {
            ...
            if (null != DJISampleApplication.getCameraInstance() && DJISampleApplication.getCameraInstance().isMediaDownloadModeSupported()) {
                ...
                if (null != mMediaManager) {
                    ...
                    if (isMavicAir2() || isM300()) {
                        DJISampleApplication.getCameraInstance().enterPlayback(djiError -> {
                            if (djiError == null) {
